            ...
            <form class="form-horizontal">
                <div class="modal-body">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-xs-9">
                            <select class="form-control" name="gayabelajar_add" id="gayabelajar1">
                     ...
                     <div class="form-group">
                        ...
                        <div class="col-xs-9">
                            <textarea name="keterangan_add" id="keterangan1" cols="30" rows="6" class="form-control"></textarea>
                        </div>
                    </div>
            ...
            <form class="form-horizontal">
                <div class="modal-body">
                    ...
                    <div class="form-group">
                        <label class="control-label col-xs-3" >Gaya Belajar</label>
                        <div class="col-xs-9">
                            <select class="form-control" name="gayabelajar_edit" id="gayabelajar2">
                                <option value="A">Auditory</option>
                                <option value="V">Visual</option>
                                <option value="K">Kinestetic</option>
                            </select>
                    ...
                    <div class="form-group">
                        <label class="control-label col-xs-3" >Keterangan</label>
                        <div class="col-xs-9">
                            <textarea name="keterangan_edit" id="keterangan2" cols="30" rows="6" class="form-control"></textarea>
                        </div>
                    </div>
...
<script type="text/javascript">
    $(document).ready(function(){  
        ...
        var tableajax = $('#myTable').DataTable({
        	responsive: true,
            ajax: '<?php echo base_url("C_saran/getAjax") ?>',
            columns: [
             { 
                data: null,
        ...
        $('#btn_simpan').on('click',function(){
            ...
            $.ajax({
                type : "POST",
                url  : "<?php echo base_url('C_saran/add')?>",
                dataType : "JSON",
        ...
        $('#show_data').on('click','.item_edit',function(){
            ...
            $.ajax({
                type : "GET",
                url  : "<?php echo base_url('C_saran/where')?>",
                dataType : "JSON",
                data : {id:id},
                success: function(data){
        ...
        $('#btn_update').on('click',function(){
            ...
            $.ajax({
                type : "POST",
                url  : "<?php echo base_url('C_saran/update')?>",
                dataType : "JSON",
                data : {kode:kode, gayabelajar:gayabelajar, keterangan:keterangan},
                success: function(data){
                    $('[name="kode_edit"]').val("");
        ...
        $('#btn_hapus').on('click',function(){
            ...
            $.ajax({
                type : "POST",
                url  : "<?php echo base_url('C_saran/delete')?>",
                dataType : "JSON",
                data : {kode: kode},
                success: function(data){
